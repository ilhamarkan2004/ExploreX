...
import com.example.ExploreX.CommentActivity;
import com.example.ExploreX.FollowersActivity;
import com.example.ExploreX.Fragments.PostDetailFragment;
import com.example.ExploreX.Fragments.ProfileFragment;
import com.example.ExploreX.Model.Post;
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(post.getPublisher()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageurl().equals("default")) {
                    holder.imageProfile.setImageResource(R.drawable.foto_default);
                } else {
                    Picasso.get().load(user.getImageurl()).placeholder(R.drawable.foto_default).into(holder.imageProfile);
                }
